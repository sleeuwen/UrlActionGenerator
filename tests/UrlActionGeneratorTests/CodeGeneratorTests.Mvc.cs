...
{
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute(""UrlActionGenerator"", """ + typeof(CodeGenerator).Assembly.GetName().Version + @""")]
...
namespace Microsoft.AspNetCore.Mvc
{
    ...
    public static partial class UrlActionGenerator_UrlHelperExtensions
    {
        public static UrlActions Actions(this global::Microsoft.AspNetCore.Mvc.IUrlHelper urlHelper)
            => new UrlActions(urlHelper);

        public class UrlActions
        {
            private readonly global::Microsoft.AspNetCore.Mvc.IUrlHelper urlHelper;
            public UrlActions(global::Microsoft.AspNetCore.Mvc.IUrlHelper urlHelper)
            {
...
namespace Microsoft.AspNetCore.Mvc
{
    ...
    public static partial class UrlActionGenerator_UrlHelperExtensions
    {
        ...
        public static AdminUrlActions AdminActions(this global::Microsoft.AspNetCore.Mvc.IUrlHelper urlHelper)
            => new AdminUrlActions(urlHelper);

        public class AdminUrlActions
        {
            private readonly global::Microsoft.AspNetCore.Mvc.IUrlHelper urlHelper;
            public AdminUrlActions(global::Microsoft.AspNetCore.Mvc.IUrlHelper urlHelper)
            {
                this.urlHelper = urlHelper;
            }
...
", _code.ToString(), false, true);
        ...
        public void WriteAreaActions_DefaultArea()
        {
            ...
            // Assert
            Assert.Equal(@"public static UrlActions Actions(this global::Microsoft.AspNetCore.Mvc.IUrlHelper urlHelper)
    => new UrlActions(urlHelper);
...
", _code.ToString(), false, true);
        ...
        public void WriteAreaActions_CustomArea()
        {
            ...
            // Assert
            Assert.Equal(@"public static CustomUrlActions CustomActions(this global::Microsoft.AspNetCore.Mvc.IUrlHelper urlHelper)
    => new CustomUrlActions(urlHelper);

public class CustomUrlActions
{
    private readonly global::Microsoft.AspNetCore.Mvc.IUrlHelper urlHelper;
    public CustomUrlActions(global::Microsoft.AspNetCore.Mvc.IUrlHelper urlHelper)
    {
        this.urlHelper = urlHelper;
    }
...
public class CustomUrlActions
{
    ...
    {
        private readonly global::Microsoft.AspNetCore.Mvc.IUrlHelper urlHelper;
        public HomeControllerActions(global::Microsoft.AspNetCore.Mvc.IUrlHelper urlHelper)
        {
            this.urlHelper = urlHelper;
        }
...
public class CustomUrlActions
{
    ...
    {
        private readonly global::Microsoft.AspNetCore.Mvc.IUrlHelper urlHelper;
        public ContactControllerActions(global::Microsoft.AspNetCore.Mvc.IUrlHelper urlHelper)
        {
            this.urlHelper = urlHelper;
        }
...
", _code.ToString(), false, true);
        ...
        public void WriteAction_WithParameters()
        {
            ...
            action.Parameters.Add(new ParameterDescriptor("search", TestCompilation.Default.GetTypeByMetadataName("System.String"), false, null));
            action.Parameters.Add(new ParameterDescriptor("page", TestCompilation.Default.GetTypeByMetadataName("System.Int32"), false, null));
            ...
            Assert.Equal(@"public string List(string @search, int @page)
{
    var __routeValues = global::Microsoft.AspNetCore.Routing.RouteValueDictionary.FromArray(new global::System.Collections.Generic.KeyValuePair<string, object>[] {
        new global::System.Collections.Generic.KeyValuePair<string, object>(""area"", """"),
        new global::System.Collections.Generic.KeyValuePair<string, object>(""search"", @search),
        new global::System.Collections.Generic.KeyValuePair<string, object>(""page"", @page),
    });
...
", _code.ToString(), false, true);
        ...
        public void WriteAction_WithParametersDefaultValue()
        {
            ...
            var controller = new ControllerDescriptor(area, "Home");
            var action = new ActionDescriptor(controller, "List");
            action.Parameters.Add(new ParameterDescriptor("search", TestCompilation.Default.GetTypeByMetadataName("System.String"), true, "term\""));
            action.Parameters.Add(new ParameterDescriptor("page", TestCompilation.Default.GetTypeByMetadataName("System.Int32"), true, 1));
